  ...
  return (
    <>
      <section className="reference-slider" aria-label="Featured smoothAir products">
        ...
        <button className="slider-arrow left" type="button" onClick={() => changeSlide(-1)} aria-label="Previous featured product">‹</button>
        <button className="slider-arrow right" type="button" onClick={() => changeSlide(1)} aria-label="Next featured product">›</button>
      ...
      <main className="reference-content">
        ...
        <section className="about-panel">
          ...
          <aside className="vision-column"><div><h3>◉ Vision</h3><p>To be recognized as a market leader of sustainable solutions that create value and exceed customer expectation in ducting.</p></div><div><h3>◉ Mission</h3><p>Commitment to satisfy customer demand for ducting, using our knowledge, experience, dedication and adherence to the best quality standards.</p></div></aside>
        </section>
      </main>
    </>
  )
